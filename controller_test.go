...
import (
	...
	//topologycontroller "k8s.io/topo-controller/pkg/apis/topologycontroller/v1alpha1"
	//"k8s.io/topo-controller/pkg/generated/clientset/versioned/fake"
	//informers "k8s.io/topo-controller/pkg/generated/informers/externalversions"
	topologycontroller "pkg/apis/topocontroller/v1alpha1"
...
type fixture struct {
	...
	fooLister        []*topologycontroller.Foo
...
func newFoo(name string, replicas *int32) *topologycontroller.Foo {
	return &topologycontroller.Foo{
		TypeMeta: metav1.TypeMeta{APIVersion: topologycontroller.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: topologycontroller.FooSpec{
...
func (f *fixture) expectUpdateFooStatusAction(foo *topologycontroller.Foo) {
...
func getKey(foo *topologycontroller.Foo, t *testing.T) string {
